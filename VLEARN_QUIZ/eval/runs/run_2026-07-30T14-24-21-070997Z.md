...
- Thời gian: `2026-07-30T14:24:21.070997Z`
- Tổng: `27/30` (`90.0%`)
- Hard/edge: `19/20` (`95.0%`)
- Quality bar 80%: `PASS`
...
| `TC_HAPPY_09` | Happy Path | FAIL | missing required topics: ['3 nhóm ML', 'Hồi quy (Regression)', 'Phân loại (Classification)'] |
| `TC_HAPPY_10` | Happy Path | PASS | All automated assertions passed |
| `TC_HARD_CLASS1_01` | Lớp 1 — Nguồn sự thật | FAIL | expected success, got 'rejected'; expected 1 questions, got 0 |
